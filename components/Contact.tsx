        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <p className="text-blue-100 mb-8 leading-relaxed">
              Butuh designer untuk proyek brand identity, logo, atau konten
              sosial media? Atau sedang membuka lowongan? Hubungi saya!
            </p>
          ...
          <form className="space-y-4">
            ...
            <input
              ...
              className="w-full bg-transparent border-2 border-white px-4 py-3 text-white placeholder-blue-200 focus:outline-none focus:border-[#F5C518]"
            />
            <select className="w-full bg-[#1A4BFF] border-2 border-white px-4 py-3 text-white focus:outline-none focus:border-[#F5C518]">
            ...
            <button
              type="submit"
              className="w-full bg-[#F5C518] text-black font-bold uppercase tracking-wider py-4 hover:bg-white transition-colors duration-200"
              style={{ fontFamily: 'Josefin Sans, sans-serif' }}
            >
              Send Message →
            </button>
